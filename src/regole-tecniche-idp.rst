...
.. Important::
    ...
    La firma deve essere prodotta secondo il profilo specificato per SAML (SAML-Metadata, cap. 3) utilizzando chiavi RSA almeno a 1024 bit e algoritmo di digest SHA-256 o superiore;
...
status code avente valore 200 ("OK"):
    ...
    * **Il browser** dell'utente elabora quindi la risposta HTTP e invia una richiesta HTTP POST verso il componente Single Sign-On dell'Identity Provider (``SingleSignOnService``).
